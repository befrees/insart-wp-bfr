    ...
    <div class="container mt100">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="pr120">
                    <p class="title_block mr120 "><?php echo get_field('commercial_lending_software_title'); ?></p>
                </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="pr120">
                    <p class="title_block "><?php echo get_field('debt_collection_software_title'); ?></p>
                </div>
                        ...
                        while ($the_insights->have_posts()) {
                            ...
                            <li class="text-center">
                                <div class="box_article">
                                    ...
                                    <p class="t1_insights1"><a href="<?php echo get_field('our_insights_link'); ?>"><?php the_title(); ?></a>
                                    </p>
