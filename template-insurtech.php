...
<section class="sect_dots s3_wealthtech">
    ...
    <img class="cicles_grid1_insurance" src="<?php bloginfo('template_url'); ?>/assets/images/cicles_grid1_insurance.svg" alt="" />
    ...
    <div class="container cont1_s3 pos_rel">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="box_more_it"><a href="<?php echo get_field('insurtech_book_post_read_abstract'); ?>" class="more_it" target="_blank"><?php echo get_field('insurtech_book_post_read_abstract_name_link'); ?>
                        <img class="arrow_it" src="<?php bloginfo('template_url'); ?>/assets/images/arrow.svg" alt="" /></a></div>
