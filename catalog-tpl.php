...
// dd($wp_query);
 ?>
    ...
    <div class="wrapper">
        ...
        <div class="middle nopadding-top content-bg" id="middle">
            <div class="container-big">
                <div class="row">
                    <h1 class="h1 text-center"><?= get_the_title(); ?></h1>
                    <div class="content">
                                            ...
                                            <div class="block-level-2" style="background-color: <?= hex2rgba($id_color, '.1') ?>">
                                                ...
                                                <?php if($level3 = $term2['child']): ?>
                                                    ...
                                                    <div class="row-filter">
                                                        <input type="checkbox" 
                                                        <?= ($api_get && in_array($item['term_id'], $api_get)) ? 'checked' : '' ?> 
                                                        name="api[]" 
                                                        value="<?= $item['term_id'] ?>"
                                                        id="api_<?= $item['term_id'] ?>" 
                                                        class="checkbox-styler-color" 
                                                        data-color="<?= $id_color ? $id_color : '#333' ?>">
                ...
                <span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span><span class="path7"></span><span class="path8"></span>
                        ...
                        <div class="col-lg-9 col-catalog-list" id="ajax-content">
                            <div class="row flexbox flex-wrap" id="load_more_gs">
                        ...
                        <?php if (  $wp_query->max_num_pages > 1 ) : ?>
                            ...
                            data-true_posts='<?php echo serialize($wp_query->query_vars); ?>'
    ...
    <?php get_template_part( 'parts/api-form' ); ?>
    <?php get_footer(); ?>
