...
?>
        ...
        <div class="container cont1_s4 pos_rel">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <h2 class="t1_s4"><?php echo get_field('wealthtech_components_we_develop_title'); ?></h2>

                </div>

                <div class="col-md-6 col-sm-6">

                    <p class="t2_s4"><?php echo get_field('wealthtech_components_we_develop_subtitle'); ?></p>
        ...
        <div class="container cont1_s3 pos_rel">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <h2 class="t1_s4"><?php echo get_field('wealthtech_integrations_we_work_with_title'); ?></h2>

                </div>

                <div class="col-md-6 col-sm-6">

                    <p class="t2_s4"><?php echo get_field('wealthtech_integrations_we_work_with_text_box'); ?></p>
    ...
    <section class="s5_wealthtech ">
        ...
        <img class="cicles_grid3_wealthtech"
             src="<?php bloginfo('template_url'); ?>/assets/images/cicles_grid3_wealthtech.svg" alt=""/>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div class="block_brokers">
                        ...
                        <!--<div class="col-md-4 col-sm-6 col-xs-6"><img class="broker1" src="<?php bloginfo('template_url'); ?>/assets/images/broker1.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker2" src="<?php bloginfo('template_url'); ?>/assets/images/broker2.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker3" src="<?php bloginfo('template_url'); ?>/assets/images/broker3.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/broker4.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/broker5.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/broker6.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker7" src="<?php bloginfo('template_url'); ?>/assets/images/broker7.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker10" src="<?php bloginfo('template_url'); ?>/assets/images/broker10.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker9" src="<?php bloginfo('template_url'); ?>/assets/images/broker9.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="broker8" src="<?php bloginfo('template_url'); ?>/assets/images/broker8.jpg" alt="" /></div> -->
            ...
            <div class="row row2_s5_wealthtech">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div class="block_brokers">
                        ...
                        <!-- <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/crm1.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="" src="<?php bloginfo('template_url'); ?>/assets/images/crm2.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="" src="<?php bloginfo('template_url'); ?>/assets/images/crm3.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/crm4.png" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/crm5.png" alt="" /></div> -->
            ...
            <div class="row row2_s5_wealthtech">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div class="block_brokers">
                        ...
                        <!-- <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/provider1.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="" src="<?php bloginfo('template_url'); ?>/assets/images/provider2.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img class="" src="<?php bloginfo('template_url'); ?>/assets/images/provider3.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/provider4.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/provider5.jpg" alt="" /></div>

                            <div class="col-md-4 col-sm-6 col-xs-6"><img src="<?php bloginfo('template_url'); ?>/assets/images/provider6.jpg" alt="" /></div> -->
...
//                            $image = get_field('featured_clients_logotyp');
                        ...
                        <?php foreach ($comments as $comment): ?>
                            <div class="row row_clients">
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    $image = $comment['img'];
                                    if (!empty($image)): ?>
                                        <img class="clients_img" src="<?php echo $image['url']; ?>"
                                             alt="<?php echo $image['alt']; ?>"/>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-8 col-sm-8">
            ...
            <div class="row row_clients">
                ...
                <div class="col-md-8 col-sm-8">
                    <p class="text_clients"><?php echo get_field('featured_clients_text_box_1'); ?></p>
                    <p class="text_clients text2_clients"><?php echo get_field('featured_clients_text_box_2'); ?></p>
                </div>
            </div>
            <div class="row row_clients">
                <div class="col-md-4 col-sm-4">
                    <?php
                    $image = get_field('featured_clients_image_avatar');
                    if (!empty($image)): ?>
                        <img class="clients_img" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>"/>
                    <?php endif; ?>
                </div>
                <div class="col-md-8 col-sm-8">
                    <p class="name_clients"><?php echo get_field('featured_clients_avatar_name'); ?></p>
                    <p class="info_clients"><?php echo get_field('featured_clients_avatar_position'); ?></p>
                    <p class="text_clients text2_clients"><?php echo get_field('featured_clients_avatar_description'); ?></p>
                </div>
    ...
    <section class="sect_dots s3_wealthtech">
        ...
        <img class="cicles_grid4_wealthtech"
             src="<?php bloginfo('template_url'); ?>/assets/images/cicles_grid4_wealthtech.svg" alt=""/>
        ...
        <div class="container cont1_s3 pos_rel">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <p class="numb_wealthtech"><?php echo get_field('wealthtech_club_members_number_title'); ?></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <h2 class="t1_s4"><?php echo get_field('wealthtech_club_members_title'); ?></h2>

                </div>

                <div class="col-md-6 col-sm-6">

                    <p class="t2_s4"><?php echo get_field('wealthtech_club_members_subtitle'); ?></p>
        ...
        <div class="container cont2_member box_member">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo1');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo2');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo3');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo4');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo5');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo6');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
            ...
            <div class="row row2_member">

                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo7');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo8');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo9');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo10');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo11');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
                ...
                <div class="col-md-2 col-sm-4">
                                    <?php 
                                        $image = get_field('wealthtech_club_members_logo12');
                                        if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                                    <?php endif; ?>
				</div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box_more_member"><a
                                href="<?php echo get_field('wealthtech_club_members_link_view_all'); ?>"
                                class="more_member"
                                target="_blank"><?php echo get_field('wealthtech_club_members_name_view_all'); ?><img
                                    class="arrow_member"
                                    src="<?php bloginfo('template_url'); ?>/assets/images/arrow.svg" alt=""/></a></div>
